...
class Trader:
    def __init__(self) -> None:
        ...
        self.coconut_window = Window(5)
        self.pina_coladas_window = Window(5)
    ...
    def arbitrage_calc(self, product_1: Product, product_2: Product,
        ...
        proportion_per_timestamp = 0.15
        
        # margin buy 1 sell 2
        margin_1 =  best_bid_price_product_1 * lot_size_product_1 - best_ask_price_product_2 * lot_size_product_2

        # margin buy 2 sell 1
        margin_2 =  best_bid_price_product_2 * lot_size_product_2 - best_ask_price_product_1 * lot_size_product_1
        ...
        if best_bid_price_product_1 > best_ask_price_product_2 * product_1_over_product_2_value_ratio:
            ...
            if False in (np.array(self.coconut_window.contents) > 0):
                pass
            elif len(self.coconut_window.contents) == self.coconut_window.size:
                if self.coconut_window.avg() > margin_1:
            ...
            '''
                ...
                sell_price_product_1 = best_bid_price_product_1
                '''
        self.coconut_window.push(margin_1)
        ...
        if best_bid_price_product_2 * product_1_over_product_2_value_ratio > best_ask_price_product_1:
            ...
            if False in (np.array(self.pina_coladas_window.contents) > 0):
                pass
            elif len(self.pina_coladas_window.contents) == self.pina_coladas_window.size:
                if np.mean(self.pina_coladas_window.contents) > margin_2:
            ...
            '''
                ...
                sell_price_product_2 = best_bid_price_product_2
                '''
        self.pina_coladas_window.push(margin_2)
