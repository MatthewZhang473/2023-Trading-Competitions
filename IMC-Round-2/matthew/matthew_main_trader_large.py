...
class Trader:
    def __init__(self) -> None:
        ...
        self.profit_margin_window_size = 4
        self.profit_margin_buy_2_sell_1 = Window(self.profit_margin_window_size)
        self.profit_margin_buy_1_sell_2 = Window(self.profit_margin_window_size)
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        arbitrage_COCONUTS_orders, arbitrage_PINAS_orders =\
            self.arbitrage_calc(state.timestamp,
    ...
    def arbitrage_calc(self, timestamp: int,
                       product_1: Product, product_2: Product,
        ...
        margin_buy_product_2_sell_product_1 = best_bid_price_product_1 * lot_size_product_1 - best_ask_price_product_2 * lot_size_product_2
        
        # the profit margin plateaus
        if margin_buy_product_2_sell_product_1 <= self.profit_margin_buy_2_sell_1.upper_lower_bounds(n=small_sigma)[1]\
           and min(self.profit_margin_buy_2_sell_1.contents) > 0\
           and timestamp > self.profit_margin_window_size * 100: 
            ...
            max_number_buy_lots = min(proportionality*margin_buy_product_2_sell_product_1,\
            ...
            max_number_sell_lots = min(proportionality*margin_buy_product_2_sell_product_1,\
                                       best_bid_volume_product_1,\
                                       position_limit_product_1 + position_product_1)//lot_size_product_1
            
            # trade aggresively if the profit margin decreases fast
            if margin_buy_product_2_sell_product_1 <= self.profit_margin_buy_2_sell_1.upper_lower_bounds(n=large_sigma)[1]\
            or margin_buy_product_2_sell_product_1 >= good_in_size:
            ...
            print(f"The profit margin is {margin_buy_product_2_sell_product_1}, number of trade lots available is {number_trade_lots}")
        ...
        # push the current margin to the window
        self.profit_margin_buy_2_sell_1.push(margin_buy_product_2_sell_product_1)
    
        # if normalized product 1 is cheaper than prodcut 2
        margin_buy_product_1_sell_product_2 = best_bid_price_product_2 * lot_size_product_2 - best_ask_price_product_1 * lot_size_product_1
        
        if margin_buy_product_1_sell_product_2 <= self.profit_margin_buy_1_sell_2.upper_lower_bounds(n=small_sigma)[1]\
           and min(self.profit_margin_buy_1_sell_2.contents) > 0\
           and timestamp > self.profit_margin_window_size * 100:
            # buy in product 1, sell product 2
            # how many lots of product 1 can I buy from the order book, without breaching position limit
            max_number_buy_lots = min(proportionality*margin_buy_product_1_sell_product_2,\
                                      best_ask_volume_product_1,\
                                      position_limit_product_1 - position_product_1)// lot_size_product_1
            
            # how many lots of product 2 can I sell from the order book, without breaching position limit
            max_number_sell_lots = min(proportionality*margin_buy_product_1_sell_product_2,\
                                       best_bid_volume_product_2,\
                                       position_limit_product_2 + position_product_2)//lot_size_product_2
            
            #trade aggresively if the profit margin is decreasing fast
            if margin_buy_product_1_sell_product_2 <= self.profit_margin_buy_1_sell_2.upper_lower_bounds(n=large_sigma)[1]\
            or margin_buy_product_1_sell_product_2 >= good_in_size:
            ...
            number_trade_lots = min(max_number_buy_lots, max_number_sell_lots) # the number of lots I can trade, this is the smaller of the two
            print(f"The profit margin is {margin_buy_product_1_sell_product_2}, number of trade lots available is {number_trade_lots}")
        ...
        # push the margin into the window
        self.profit_margin_buy_1_sell_2.push(margin_buy_product_1_sell_product_2)
