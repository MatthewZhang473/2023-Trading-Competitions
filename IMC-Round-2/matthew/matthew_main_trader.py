...
class Trader:
    ...
    def arbitrage_calc(self, product_1: Product, product_2: Product,
        ...
        if margin_buy_product_2_sell_product_1 > 0:
            ...
            # if we are holding the wrong side of position, we clear out asap
            # if position_product_2 < 0:
            #     max_number_buy_lots = min(best_ask_volume_product_2,\
            #                               position_limit_product_2)//lot_size_product_2
            ...
            # if we are holding the wrong side of position, we clear out asap
            # if position_product_1 > 0:
            #     max_number_sell_lots = min(best_bid_volume_product_1,\
            #                               position_limit_product_1)//lot_size_product_1
        ...
        if margin_buy_product_1_sell_product_2 > 0:
